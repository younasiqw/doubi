...
Download_caddy(){
	...
	if [[ ${bit} == "x86_64" ]]; then
		wget --no-check-certificate -O "caddy" "https://github.com/younasiqw/Caddy_Linux/releases/latest/download/caddy_v2_linux_amd64"
	elif [[ ${bit} == "i386" || ${bit} == "i686" ]]; then
		wget --no-check-certificate -O "caddy" "https://github.com/younasiqw/Caddy_Linux/releases/latest/download/caddy_v2_linux_386"
	elif [[ ${bit} == "armv7l" ]]; then
		wget --no-check-certificate -O "caddy" "https://github.com/younasiqw/Caddy_Linux/releases/latest/download/caddy_v2_linux_armv7"
	else
